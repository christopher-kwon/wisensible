...
alert('경매글은 한 번 작성하면 수정/삭제 할 수 없습니다. 신중하게 작성 부탁드립니다. 경매 종료는 글 작성 시간 기준 10분뒤 입니다.')
		...
		if(pattern.test(board_filename4)) {
			...
			$("form").submit(function() {
						...
						if ($.trim($("#filevalue1").text()) == "") {
							alert("경매글은 사진 4장을 필수로 첨부해야 합니다.1")
						...
						if ($.trim($("#filevalue2").text()) == "") {
							alert("경매글은 사진 4장을 필수로 첨부해야 합니다.2")
						
							return false;

						}
						
								if ($.trim($("#filevalue3").text()) == "") {
							alert("경매글은 사진 4장을 필수로 첨부해야 합니다.3")
						...
						if ($.trim($("#filevalue4").text()) == "") {
							alert("경매글은 사진 4장을 필수로 첨부해야 합니다.4")
