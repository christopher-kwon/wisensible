...
public class CommentBean {
	...
	public int getComment_board_ref() {
		return comment_board_ref;
	}
	public void setComment_board_ref(int comment_board_ref) {
		this.comment_board_ref = comment_board_ref;
	}
