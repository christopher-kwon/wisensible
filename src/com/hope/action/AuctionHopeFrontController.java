...
@WebServlet("*.ho")
public class AuctionHopeFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		case "/AuctionhopeAdd.ho" :
			action = new AuctionhopeAdd();
			break;
			
		case "/AuctionhopeGet.ho" :
			action = new AuctionhopeGet();
			break;
